...
TH1D* G4PMTSim::fTimeTraceHisto;
TH1D* G4PMTSim::fSignalTimeTraceHisto;
TH1D* G4PMTSim::fNoiseTimeTraceHisto;
TH1D* G4PMTSim::fPETimeDistributionHisto;
TH1D* G4PMTSim::fSPETimeTraceHisto;
std::vector<TH1D*> G4PMTSim::fSPETimeTrace;	
...
bool G4PMTSim::GeneratePhotonsFast(double x,double Edep){
...
bool G4PMTSim::GeneratePEFast(double x,double Edep){
...
void G4PMTSim::SPEPulseSpectrum(double t_cathode,int PulseModel){
...
void G4PMTSim::NoisePulseSpectrum(){
...
double G4PMTSim::GainGenerator(int GainModel){
  ...
  double gain_spread_par=0.;	
	...
	if(GainModel==kGauss) {	
		...
		TF1* GainDistrFcn= new TF1("GainDistrFcn",G4PMTSim::PolyaFcn,1.E+05,1.E+07,2);
...
double G4PMTSim::PolyaFcn(double* x,double* par){
...
double G4PMTSim::GetQEFromTable(double E){
